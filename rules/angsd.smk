...
rule angsd_GL2:
  ...
  shell:
    """
    angsd -b 'list/realignedBAM_depth10.list' -ref {input.ref} -out angsd/angsd_LC_GL2_cutoff.nInd{wildcards.IND} -uniqueOnly 1 -remove_bads 1 -only_proper_pairs 1 -trim 0 -minMapQ 20 -minQ 20 -minInd {wildcards.IND} -setMinDepth 400 -setMaxDepth 2000 -GL 2 -doGlf 2 -doMajorMinor 1 -doMaf 1 -SNP_pval 1e-6 -doCounts 1 2> {log}
    """
